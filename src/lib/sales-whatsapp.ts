...
export type SalesWhatsAppType = "invoiceSent" | "paymentReminder" | "paymentReceived";
...
export const SALES_WHATSAPP_VARIABLES = ["{name}", "{invoice_no}", "{total}", "{balance}", "{amount}", "{due_date}", "{shop_name}", "{shop_phone}"];
